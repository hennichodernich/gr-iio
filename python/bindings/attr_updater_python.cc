...
/* BINDTOOL_HEADER_FILE_HASH(1311e1e6dd3a51051fdbc1eb30d43cb6)                     */
/***********************************************************************************/
...
void bind_attr_updater(py::module& m)
{
    ...
    py::class_<attr_updater, gr::block, gr::basic_block,
        ...
        .def("set_value",&attr_updater::set_value,       
            py::arg("value"),
            D(attr_updater,set_value)
        )
